...
export const COMMON_JUNK_ITEMS: CommonJunkItemConfig[] = [
  ...
  item("box_spring", "Box spring", 75, { laborMinutes: 15, loadPercentage: 8, disposalCategory: "mattress" }),
  ...
  item("refrigerator", "Refrigerator", 135, { laborMinutes: 30, crewSize: 2, heavy: true, specialDisposal: true, disposalFee: 35, loadPercentage: 15, disposalCategory: "freon_appliance" }),
  item("freezer", "Freezer", 120, { laborMinutes: 28, crewSize: 2, heavy: true, specialDisposal: true, disposalFee: 30, loadPercentage: 12, disposalCategory: "freon_appliance" }),
  ...
  item("desk", "Desk", 85, { laborMinutes: 18, loadPercentage: 8, disposalCategory: "general_junk" }),
  ...
  item("treadmill", "Treadmill", 135, { laborMinutes: 40, crewSize: 2, heavy: true, loadPercentage: 18, disposalCategory: "scrap_metal" }),
  ...
  item("hot_tub", "Hot tub", 475, { laborMinutes: 180, crewSize: 3, heavy: true, specialDisposal: true, disposalFee: 85, loadPercentage: 75, disposalCategory: "bulky_special", notes: "Requires review" }),
