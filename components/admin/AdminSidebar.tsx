...
export const ADMIN_NAV = [
  ...
  { href: "/admin/scrap-fridays", label: "Scrap Fridays", icon: Recycle },
  { href: "/admin/pricing", label: "Pricing", icon: DollarSign },
  { href: "/admin/services", label: "Services", icon: Wrench },
  { href: "/admin/equipment", label: "Equipment catalog", icon: Wrench },
  { href: "/admin/equipment-leads", label: "Equipment leads", icon: ClipboardCheck },
